...
define("components/spriteComponent", ["require", "exports", "graphicsAPI", "components/component", "components/textureComponent"], function (require, exports, GraphicsAPI, component_7, textureComponent_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class LayerComponent extends component_15.Component {
        ...
        display(dT) {
            ...
            for (const sprite of layerSprites) {
                vertices.set(sprite.getVertices(), count * 4 * textureComponent_3.TextureComponent.vertexSize);
        ...
        iterate(dT) {
            ...
            for (let i = 0; i < colliders.length; i++) {
                ...
                for (let j = i + 1; j < colliders.length; j++) {
                    ...
                    if (c1.flag & c2.mask) {
                        if (c1.area.intersectsWith(c2.area)) { //rectangle englobant
                            console.log(c1.flag & c2.mask);
